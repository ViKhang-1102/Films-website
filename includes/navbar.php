...
<header>
    <nav class="navbar navbar-expand-lg navbar-dark bg-black border-bottom border-secondary sticky-top">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center gap-2 fw-bold text-warning" href="/index.php">
            ...
            <div class="collapse navbar-collapse" id="mainNavbar">
                      ...
                      <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="genreDropdown">
                          <?php while($__c = $__cats->fetch_assoc()): ?>
                            <li><a class="dropdown-item" href="/category.php?id=<?php echo $__c['id']; ?>"><?php echo htmlspecialchars($__c['name']); ?></a></li>
                          <?php endwhile; ?>
                        </ul>
                      </li>
                    <?php endif; ?>
                    <li class="nav-item"><a class="nav-link" href="/category.php?type=single">Phim lẻ</a></li>
                    <li class="nav-item"><a class="nav-link" href="/category.php?type=series">Phim bộ</a></li>
                ...
                <?php if (!isset($_SESSION['user'])): ?>
                  <a class="btn btn-warning fw-semibold" href="/login.php">
                ...
                <?php else: ?>
                  <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-dark dropdown-menu-end">
                      <li><a class="dropdown-item" href="<?php echo rtrim(BASE_PATH, '/'); ?>/profile.php"><i class="fa-regular fa-user me-2"></i>Hồ sơ</a></li>
                      <?php if (($_SESSION['user']['role'] ?? 'user') === 'admin'): ?>
                      <li><a class="dropdown-item" href="<?php echo rtrim(BASE_PATH, '/'); ?>/admin/dashboard.php"><i class="fa-solid fa-gauge me-2"></i>Quản trị</a></li>
                      <?php endif; ?>
                      <li><hr class="dropdown-divider"></li>
                      <li><a class="dropdown-item" href="<?php echo rtrim(BASE_PATH, '/'); ?>/logout.php"><i class="fa-solid fa-right-from-bracket me-2"></i>Đăng xuất</a></li>
                    </ul>
                  </div>
                <?php endif; ?>
            </div>
